...
export const FeedbackEditarOferta = ({ state, dispatch, borrar }) => {
    ...
    <div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ¿Estas seguro de querer eliminar la oferta?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
      ...
      >
        <Alert
          ...
          severity="success"
        >
          Oferta editada en la base de datos exitosamente
        </Alert>
      </Snackbar>
      ...
      >
        <Alert
          ...
          severity="error"
        >
          Error. No se logro editar la oferta.
        </Alert>
      </Snackbar>
      ...
      >
        <Alert
          ...
          severity="success"
        >
          Oferta eliminada de la base de datos
        </Alert>
      </Snackbar>
